#' Weather dataset per French region in 2020
#'
...
#' \dontrun{
#' dfweather_data_dep2020 <- weather_data_from_NOAA(
#'       Regions_or_Dept_stations_pop = SEIRcovid19FR::Dept_stations_pop,
#'       years = 2020,
#'       n.cores = 2
#'       )
#' save(dfweather_data_dep2020, file = "dfweather_data_dep2020.rdata")
#' }
"dfweather_data_dep2020"
